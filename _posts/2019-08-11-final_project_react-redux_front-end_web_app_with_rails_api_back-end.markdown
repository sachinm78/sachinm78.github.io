...
**1. REACT**
*a. Getting started
b. Container Components vs Presentational Components*
...
**3. RAILS API**
*a. Creating seed data
b. Connecting your API to your React*
...
* [Mock-bnb](https://www.youtube.com/watch?v=cRuJCeXZadM)
* [Kais-surf-shop Part 1](https://www.youtube.com/watch?v=nnqmLFop8Cg)
* [Kais surf-shop Part 2](https://www.youtube.com/watch?v=9KrrlWy1E_A)
...
(Image source: https://hackernoon.com/hn-images/1*eXN1LlNnuZmosJ7n7EsJ-Q.png)
...
* [Saving External API Data to Your Rails API](https://itnext.io/saving-external-api-data-to-your-own-rails-api-fad0fa75066)
...
* [Randomness API](https://github.com/sachinm78/Randomness-api)
* [Randomness Client](https://github.com/sachinm78/Randomness-client)
